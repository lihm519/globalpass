...
DB_HOST = "aws-0-northeast-1.pooler.supabase.com"
DB_PORT = 6543
DB_NAME = "postgres"
DB_USER = "postgres.mzodnvjtlujvvwfnpcyb"
...
def init_database():
    ...
    try:
        ...
        # 尝试备用连接
        try:
            DB_HOST_ALT = "aws-0-southeast-1.pooler.supabase.com"
            conn = psycopg2.connect(
                host=DB_HOST_ALT,
                port=DB_PORT,
                database=DB_NAME,
