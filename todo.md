...
- [x] 创建 pages/esim/[country].tsx
- [x] 实现 getStaticPaths（生成所有国家路径）
- [x] 实现 getStaticProps（服务端获取套餐数据）
...
- [x] 创建 pages/esim/index.tsx（套餐列表页）
...
## 修复 i18n 初始化错误 (2026-02-07)
- [x] 在 _app.tsx 中导入 i18n 配置
- [x] 确保 i18n 在所有页面加载前初始化
- [x] 推送修复到生产环境

## 修复 i18n 导入路径 (2026-02-07)
- [x] 将 @/lib/i18n 改为相对路径 ../lib/i18n
- [ ] 推送修复到生产环境
